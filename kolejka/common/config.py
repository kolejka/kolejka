...
class KolejkaConfig:
    def __init__(self, config_file=None, config=None, args=None, **kwargs):
        ...
        self.client.__setattr__('image_size', parse_memory(client_config.get('image_size', default_config.get('image_size', None))))
        ...
        self.foreman.__setattr__('image_size', parse_memory(foreman_config.get('image_size', default_config.get('image_size', None))))
        ...
        self.worker.__setattr__('image_size', parse_memory(worker_config.get('image_size', default_config.get('image_size', None))))
